              ...
              <div class="card card-primary">
                ...
                <form role="form" action="{{route('khunggio.store')}}" method="post" enctype="multipart/form-data">
                  ...
                  <div class="form-group">
                    ...
                    <div class="form-group">
                      <label for="exampleName">Giới hạn lượt đặt</label>
                      <input type="text" class="form-control" id="gioihanluongdat" placeholder="Số lượng" name="gioihanluongdat" value="{{old('gioihanluongdat')}}">
                    </div>
                  <!-- /.card-body -->
